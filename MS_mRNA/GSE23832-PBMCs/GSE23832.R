...
celFilesDirectory= "E:/miRNAAA/PBMC/mRNA/3-GSE23832-PBMCs/GSE23832"
cels_GSE = list.celfiles(celFilesDirectory, full.names = TRUE)
cels_GSE

affyData <- read.celfiles(cels_GSE)
affyData
...
sampleInfo$`disease state:ch1` <- c(rep("HC", 4),rep("MS", 8))#Optionally, rename to shorter sample names
