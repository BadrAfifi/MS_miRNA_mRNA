...
celFilesDirectoryMS= "E:/miRNAAA/PBMC/mRNA/9-GSE15245-peripheral blood/GSE15245/U133A 2.0_MS"
celFilesDirectoryCIS= "E:/miRNAAA/PBMC/mRNA/9-GSE15245-peripheral blood/GSE15245/U133A 2.0_CIS"
celFilesDirectory <- c(celFilesDirectoryMS,celFilesDirectoryCIS)
...
design
colnames(design) <- c("CIS","MS") ## rename the columns to select them easly later 
...
contrasts <- makeContrasts(MS - CIS,
                           levels=design)
